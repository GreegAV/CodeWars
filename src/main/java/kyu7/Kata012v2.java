...
/*
Kata: Printer Errors
Task: In a factory a printer prints labels for boxes. For one kind of boxes the printer has to use colors which,
...
as a string representing a rational whose numerator is the number of errors and the denominator
