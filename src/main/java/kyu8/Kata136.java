...
Task:
http://i.imgur.com/hpDQY8o.png?1
...
receives the coordinates of the three vertices A, B and C as three different arguments and outputs the coordinates
of the barycenter O in an array [xO, yO]
...
http://i.imgur.com/B0tjxUG.jpg?1
...
class Kata136 {
    ...
    public static double[] barTriang(double[] x, double[] y, double[] z) {
        double resX = Math.round(((x[0] + y[0] + z[0]) / 3.0) * 10000) / 10000.0;
        double resY = Math.round(((x[1] + y[1] + z[1]) / 3.0) * 10000) / 10000.0;
