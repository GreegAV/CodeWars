...
/*
Kata: "this" is a problem
Task: We want to create a constructor function 'NameMe', which takes first name and last name as parameters.
...
public class Kata141 {
    ...
    public Kata141(String first, String last) {
        this.firstName = first;
        this.lastName = last;
