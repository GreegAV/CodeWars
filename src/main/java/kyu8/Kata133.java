...
Task: #Issue Looks like some hoodlum plumber and his brother has been running around and damaging your stages again.
...
you can assume every number in the sequence after the first index will be greater than the previous
 ...
 */
public class Kata133 {
    public static int[] pipeFix(int[] numbers) {
        // Fix the pipes!
        int counter=0;
        int[] pipe = new int[numbers[numbers.length-1]-numbers[0]+1];
