...
Task: Sometimes, I want to quickly be able to convert miles per imperial gallon into kilometers per liter.
 ...
 */
public class Kata131 {
    public static float mpgToKPM(final float mpg) {
        return Float.parseFloat(String.format("%.2f", mpg * 1.609344f / 4.54609188f));
    }
}