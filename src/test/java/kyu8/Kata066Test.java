...
public class Kata066Test {

    @Test
    public void test1() {
        Object[] haystack1 = {"3", "123124234", null, "needle", "world", "hay", 2, "3", true, false};
        assertEquals("found the needle at position 3", Kata066.findNeedle(haystack1));
    }

    @Test
    public void test2() {
        Object[] haystack2 = {"283497238987234", "a dog", "a cat", "some random junk", "a piece of hay", "needle", "something somebody lost a while ago"};
        assertEquals("found the needle at position 5", Kata066.findNeedle(haystack2));
    }
    ...
    public void test3() {
        ...
        assertEquals("found the needle at position 30", Kata066.findNeedle(haystack3));
    }
}