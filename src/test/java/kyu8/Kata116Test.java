...
public class Kata116Test {
    ...
    public void firstTest() throws Exception {
        ...
        assertEquals(expectedResult, Kata116.filterOddNumber(listOfNumbers));
    }
    ...
    public void secondTest() {
        ...
        assertEquals(Arrays.toString(expectedResult.toArray()), Arrays.toString(Kata116.filterOddNumber(listOfNumbers).toArray()));
    }
